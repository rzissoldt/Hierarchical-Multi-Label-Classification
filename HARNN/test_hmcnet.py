...
def test_hmcnet(args):
    ...
    test_dataset = HmcNetDataset(annotation_file_path=args.test_file,hierarchy_file_path=args.hierarchy_file,image_dir=image_dir,path_to_model=path_to_model,hierarchy_dicts_file_path=args.hierarchy_dicts_file)
