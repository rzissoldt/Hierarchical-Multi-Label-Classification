...
def test_hmcnet(args):
    ...
    # Define Model
    model = HmcNet(feature_dim=args.feature_dim_backbone,attention_unit_size=args.attention_dim,backbone_fc_hidden_size=args.backbone_dim,highway_fc_hidden_size=args.highway_fc_dim,highway_num_layers=args.highway_num_layers,num_classes_list=num_classes_list,total_classes=total_class_num,l2_reg_lambda=args.l2_lambda,dropout_keep_prob=args.dropout_rate,alpha=args.alpha,beta=args.beta).to(device=device)
