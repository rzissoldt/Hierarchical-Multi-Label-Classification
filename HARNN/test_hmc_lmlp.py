...
from HARNN.model.hmc_lmlp_model import HmcLMLP
from HARNN.dataset.hmc_lmlp_dataset import HmcLMLPDataset
from HARNN.tester.hmc_lmlp_tester import HmcLMLPTester
...
def test_hmc_lmlp(args):
    ...
    # Define Model
    model = HmcLMLP(feature_dim=args.feature_dim_backbone,backbone_fc_hidden_size=args.backbone_dim,fc_hidden_size=args.fc_dim,dropout_keep_prob=args.dropout_rate).to(device=device)
